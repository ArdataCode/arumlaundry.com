...
function CacheOpGetViewsHeaders( $settCache, $viewId = null )
{
	...
	if( $viewId === null || $viewId === 'cmn' )
		$res[ 'cmn' ] = array( 'User-Agent' => 'Mozilla/99999.9 AppleWebKit/9999999.99 (KHTML, like Gecko) Chrome/999999.0.9999.99 Safari/9999999.99 seraph-accel-Agent/2.20.36' );
...
function _AddSiteIdSites( &$sitesIds, $addrSite, $siteId, $availablePlugins )
{
	...
	{
		$sitePath = Gen::GetArrField( Net::UrlParse( $addrSite ), array( 'path' ) );
